...
const ResultsSearch = () => {
  ...
  const filteredJobs = selectedJob.filter((job: any) => {
  ...
  //console.log(selectedJob.response.length)
  const totalPages = Math.ceil(selectedJob.length / itemsPerPage);
  const startIndex = (currentPage - 1) * itemsPerPage;
  const currentJobs = selectedJob.slice(startIndex, startIndex + itemsPerPage);
  ...
  const applyOffer = (jobId: number): void => {
    ...
    <>
      ...
      >
        ...
        <Typography
          ...
          color="#a7a7a7"
        >
          Existen xxx ofertas de empleo de 40 empresas
        </Typography>
      </Container>
      <Container
        maxWidth="xxl"
                          ...
                          >
                            ...
                            >
                              <Button
                                ...
                                onClick={() => {
                                  applyOffer(selectedJob.oferta_id);
                                }}
                              >
                                Postularme
                              </Button>
